...
sidekick = new DockerRemote.Args(
  name: "sidekick"
  env:
                ...
                write_files:
                  ...
                  - path: /services/sidekick.service
                    ...
                    content: |
                      ...
                      ExecStop=/usr/bin/docker stop #{sidekick.container.name}
                  ...
                  - path: /services/www@.service
                    ...
                    content: |
                      ...
                      ExecStop=/usr/bin/docker stop #{www.container.name}
